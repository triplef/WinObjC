...
static XamlCompositorCS::Controls::CALayerXaml ^GetCALayer(DisplayNode *node)
{
    return (XamlCompositorCS::Controls::CALayerXaml ^) (Platform::Object ^) node->_xamlNode;
};

static XamlCompositorCS::Controls::EventedStoryboard ^GetStoryboard(DisplayAnimation *anim)
{
...
{
    auto xamlAnimation = ref new XamlCompositorCS::Controls::EventedStoryboard(beginTime, duration, autoReverse, repeatCount, repeatDuration, speed, timeOffset);
...
{
    XamlCompositorCS::Controls::EventedStoryboard ^xamlAnimation = (XamlCompositorCS::Controls::EventedStoryboard ^) (Platform::Object ^) _xamlAnimation;

    AddRef();
    xamlAnimation->Completed = ref new XamlCompositorCS::Controls::AnimationMethod([this] (Platform::Object ^sender)
    {
        this->Completed();
        XamlCompositorCS::Controls::EventedStoryboard ^xamlAnimation = (XamlCompositorCS::Controls::EventedStoryboard ^) (Platform::Object ^) this->_xamlAnimation;
...
void DisplayAnimation::Stop()
{
    ...
    Windows::UI::Xaml::Media::Animation::Storyboard ^storyboard = (Windows::UI::Xaml::Media::Animation::Storyboard ^) (Platform::Object ^) xamlAnimation->GetStoryboard();
    storyboard->Stop();
}
...
void DisplayAnimation::AddAnimation(DisplayNode *node, const wchar_t *propertyName, bool fromValid, float from, bool toValid, float to)
{
    ...
    xamlAnimation->Animate(xamlNode, ref new Platform::String(propertyName), fromValid ? (Platform::Object ^) (double) from : nullptr, toValid ? (Platform::Object ^) (double) to : nullptr);
}
...
void DisplayAnimation::AddTransitionAnimation(DisplayNode *node, const char *type, const char *subtype)
{
    ...
    async->Completed = ref new Windows::Foundation::AsyncOperationCompletedHandler<int>([newEvent] (Platform::Object ^sender, Windows::Foundation::AsyncStatus result)
    {
        SetEvent(newEvent);
    });
...
{
    Windows::UI::Xaml::Media::Imaging::WriteableBitmap^ writableBitmap = (Windows::UI::Xaml::Media::Imaging::WriteableBitmap ^) (Platform::Object ^) bitmap;
    ComPtr<IBufferByteAccess> bufferByteAccess;
...
DisplayTextureXamlGlyphs::~DisplayTextureXamlGlyphs()
{
    XamlCompositorCS::Controls::CATextLayerXaml ^textControl = (XamlCompositorCS::Controls::CATextLayerXaml ^) (Platform::Object ^) _xamlTextbox;
...
{
    XamlCompositorCS::Controls::CATextLayerXaml ^textLayer = (XamlCompositorCS::Controls::CATextLayerXaml ^) (Platform::Object ^) _xamlTextbox;
...
void IWSetXamlRoot(Windows::UI::Xaml::Controls::Grid ^grid)
{
